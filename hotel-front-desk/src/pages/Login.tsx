    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="font-display text-3xl font-bold mb-2">Front Desk Login</h2>
          <p className="text-muted-foreground mb-8">Sign in with your front desk credentials</p>
