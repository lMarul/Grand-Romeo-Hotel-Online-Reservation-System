...
const STORAGE_KEY = 'hotel_frontdesk_session';

export function AuthProvider({ children }: { children: ReactNode }) {
  const [user, setUser] = useState<FrontDeskUser | null>(null);
  ...
  const signIn = async (username: string, password: string): Promise<{ error: Error | null }> => {
    try {
      // Query the front_desk table directly
