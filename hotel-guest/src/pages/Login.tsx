...
import { Hotel, Loader2, Eye, EyeOff, Star, Shield, Wifi, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="font-display text-3xl font-bold mb-2">Guest Login</h2>
          <p className="text-muted-foreground mb-8">Sign in to manage your reservations</p>
